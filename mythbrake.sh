...
############################################
logdir="/var/log/mythtv" #change to your needs for logs
errormail="test@test.com" # this email address will be informed in case of errors
outdir="/media/backup/tv" # specify directory where you want the transcoded file to be placed
...
lang2_name="English" #This is the label of the 2nd audio stream inside the final video file
...
### Transcoding starts here, in 3 differend versions: HDTV w/ commercials, SDTV w/ and w/o commercials.
